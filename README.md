...
## Mobile layout (v2.9.6)

The mobile map gesture hint now clears the timetable arrow by a fixed 120px.
The page requests `styles.css?v=2.9.6` so browsers fetch the new stylesheet
